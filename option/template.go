...
func (t Template) DisableIPv6() bool {
	return t.DomainStrategy == option.DomainStrategy(boxConstant.DomainStrategyIPv4Only) &&
		t.DomainStrategyLocal == option.DomainStrategy(boxConstant.DomainStrategyIPv4Only)
}
